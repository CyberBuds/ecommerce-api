...
router.use('/collections', createMasterRouter('collection'));
router.use('/product-types', createMasterRouter('productType'));
router.use('/attribute-groups', createMasterRouter('attributeGroup'));
router.use('/attributes', createMasterRouter('attribute'));
...
router.use('/product-tags', createMasterRouter('tag'));
